...
###this is where the fix needs to bee applied
#model scaffold unique model codes from July 2017 need to be joined to August 2017 model scaffold
#for almonds and walnuts, to correct the unique model code in the results files
...
#merge with spatial points data.frame
setwd(file.path(resultsDir, 'data.frames'))
