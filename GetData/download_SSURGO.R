...
write.csv(mu_data, paste0('CA_mu_data_', Sys.Date(), '.csv'), row.names = FALSE)
...
setwd(file.path(soilsDir, 'soilDB_query'))
write.csv(comp_data, paste0('CA_comp_data_', Sys.Date(), '.csv'), row.names = FALSE)
dim(comp_data)
...
dim(horizon_data)
setwd(file.path(soilsDir, 'soilDB_query'))
write.csv(horizon_data, paste0('CA_horizon_data_', Sys.Date(), '.csv'), row.names = FALSE)
