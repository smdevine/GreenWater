...
results <- file.path(mainDir, 'soils_data/results/paw_check_maj_comps')
...
# par(mar= c(4.5, 5, 1, 1) + 0.1) # default is c(5,4,4,2) + 0.1 (bottom, left, top, right margins in line widths)
# plot(final_result$aws0150ck_cmH2O_wtdavg, final_result$aws0150wta, type='p', xlab=expression('SSURGO 0-150 cm PAW (cm H'[2]*'O), data aggregation test'), ylab=expression('SSURGO muggatt 0-150 cm PAW (cm H'[2]*'O)'), cex.lab=1.3, cex.axis=1.3)
# abline(0, 1, col=2, lty=2, lwd=2)
# dev.off()
