...
#get stats for each crop (doesn't work)
grapes_cropscape <- cropscape_raster
grapes_cropscape[grapes_cropscape$cropscape_masked_ag!=grapes] <- NA
...
#create set of rasters with max AD values for each MU
setwd(results_max)
subs(mu_raster, mu_data, by='mukey', which='AD_alfalfa_cmH2O_max', filename='AD_alfalfa_cmH2O_max.tif', format='GTiff', overwrite=TRUE) #alfalfa
subs(mu_raster, mu_data, by='mukey', which='AD_grapes_cmH2O_max', filename='AD_grapes_cmH2O_max.tif', format='GTiff', overwrite=TRUE) #grapes
subs(mu_raster, mu_data, by='mukey', which='AD_almonds_cmH2O_max', filename='AD_almonds_cmH2O_max.tif', format='GTiff', overwrite=TRUE) #almonds
subs(mu_raster, mu_data, by='mukey', which='AD_walnuts_cmH2O_max', filename='AD_walnuts_cmH2O_max.tif', format='GTiff', overwrite=TRUE) #walnuts

#create set of raster with min AD values for each MU
setwd(results_min)
subs(mu_raster, mu_data, by='mukey', which='AD_alfalfa_cmH2O_min', filename='AD_alfalfa_cmH2O_min.tif', format='GTiff', overwrite=TRUE) #alfalfa
subs(mu_raster, mu_data, by='mukey', which='AD_grapes_cmH2O_min', filename='AD_grapes_cmH2O_min.tif', format='GTiff', overwrite=TRUE) #grapes
subs(mu_raster, mu_data, by='mukey', which='AD_almonds_cmH2O_min', filename='AD_almonds_cmH2O_min.tif', format='GTiff', overwrite=TRUE) #almonds
subs(mu_raster, mu_data, by='mukey', which='AD_walnuts_cmH2O_min', filename='AD_walnuts_cmH2O_min.tif', format='GTiff', overwrite=TRUE) #walnuts

#create set of raster with wtd_avg AD values for each MU
setwd(results_wtdavg)
subs(mu_raster, mu_data, by='mukey', which='AD_alfalfa_cmH2O_wtdavg', filename='AD_alfalfa_cmH2O_wtdavg.tif', format='GTiff', overwrite=TRUE) #alfalfa
subs(mu_raster, mu_data, by='mukey', which='AD_grapes_cmH2O_wtdavg', filename='AD_grapes_cmH2O_wtdavg.tif', format='GTiff', overwrite=TRUE) #grapes
subs(mu_raster, mu_data, by='mukey', which='AD_almonds_cmH2O_wtdavg', filename='AD_almonds_cmH2O_wtdavg.tif', format='GTiff', overwrite=TRUE) #almonds
subs(mu_raster, mu_data, by='mukey', which='AD_walnuts_cmH2O_wtdavg', filename='AD_walnuts_cmH2O_wtdavg.tif', format='GTiff', overwrite=TRUE) #walnuts

#another way to turn non study crop values to NA
legend_alfalfa <- cropscape_legend
legend_alfalfa$VALUE[which(legend_alfalfa$CLASS_NAME!='Alfalfa')] <- NA
setwd(cropscape_results)
subs(cropscape_raster, legend_alfalfa, by='VALUE', which='VALUE', filename='alfalfa_cropland.tif', format='GTiff')
#prelim work
# cropscape_raster_cropped <- crop(cropscape_raster, mu_raster)
# setwd(results)
# writeRaster(cropscape_raster_cropped, 'cropscape_cropped.tif', format='GTiff')
# cropscape_masked <- mask(cropscape_raster_cropped, mu_raster)
